...
const workItems: WorkItem[] = [
  {
    ...
    description: 'We install end-to-end satellite trackers for transport and logistics fleets, enabling monitoring where GSM coverage is limited.',
  ...
  },
  {
    ...
    description: 'We deliver satellite radio systems and coordination support for emergency teams, events, and disaster response operations. Get quality radios using satellite technology.',
  ...
  },
  {
    ...
    description: 'We implement device security services for enterprises, including tracking, remote wipe, and digital asset protection.',
  ...
  },
  {
    ...
    description: 'Our fishing communities can now use Internet to fish, by providing condusive and attractive colours that the fish see or school of fish see under water. And you can do this via your phones. You can change any light of choice, play ringtones to attract fish, record areas with highest fish occurrence, plus much more as you can see in the link. This technology is not an innovation, but NEW invention which you can only find in JKUAT! We are now ahead of developed countries with this technology.',
